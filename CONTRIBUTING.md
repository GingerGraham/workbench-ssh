# Contributing to workbench-ssh

This is a `workbench` ecosystem module — it doesn't stand alone. It's
installed into a machine via `workbench-core`'s `wb add ssh`. Full
...
```sh
git clone https://github.com/GingerGraham/workbench-ssh.git
cd workbench-ssh
...
wb dev ssh
# — or directly:
wb track ssh --branch <your-branch>
```
